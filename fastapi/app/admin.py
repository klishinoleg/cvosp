...
from fastadmin import TortoiseModelAdmin, register, WidgetType, TortoiseInlineModelAdmin
...
class ProjectImageInlineAdmin(TortoiseInlineModelAdmin, ModelWithImageFields):
    list_display = ("id", "project", "project_name", "image_url")
    ...
    def get_model_fields_with_widget_types(
        ...
        fields = super().get_model_fields_with_widget_types(*args, **kwargs)
        fields.append(ListFieldSchema("project_name"))
        fields.append(ImageListFieldSchema("image_url"))
        return fields
...
class ImageListFieldSchema(ModelFieldWidgetSchema):
    def __init__(self, field_name) -> None:
        super().__init__(
            column_name=field_name,
            is_m2m=False, is_pk=False,
            ...
            filter_widget_type=WidgetType.Upload,
            is_immutable=True,
            filter_widget_props={},
        )
